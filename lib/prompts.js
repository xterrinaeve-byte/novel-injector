...
- 重点保留人物间的暧昧、误会、情感拉扯与亲密互动。 当出现容易引发歧义、心跳加速的台词或动作时，必须保留该具体动作、台词，以及对方的心理误判和情绪外显（如羞怯、脸红、脑补）。这些是为后续角色扮演（RP）提供的核心“互动切入点”。
- 人物姓名与身份揭示铁律：凡涉及“询问姓名、主动自报家门、获赠别称、察觉对方真实身份”的交互场景，必须完整记录其问答原话、称呼转变瞬间以及双方的第一反应。不得用“双方互相认识了”等概括性废话一笔带过，必须把原汁原味的自报台词写进剧情节点与压缩正文中。
...
目标：完整保留主线脉络、所有支线、人物行为弧光、关键伏笔。为了后续角色扮演（RP）的沉浸感，必须保留场景氛围、标志性动作和极具张力的原著台词，拒绝干瘪的流水账。
- 视角：无论原文采用何种人称，全部统一转换为第三人称全知上帝视角
- 压缩比：5:1～8:1（宁可多写，保留足够的情节血肉，也不要过度压缩）

【四、硬性质量标准】
1. 人称统一：全程第三人称；内心独白需加引号并注明归属
2. 剧情全覆盖：完整保留所有主线与支线，支线标注【支线】
3. 人物与剧情记录：拒绝干瘪大纲！ 战斗场面要保留具体的法术碰撞与输赢细节；日常互动要保留神态、动作和名台词。你要把剧情写得像“微缩版的小说”，让后续阅读它的 AI 能直接在脑海中还原出当时的画面。
4. 情感记录：必须保留角色在特定情境下的心理错觉、粉色暗示与情绪波动（允许记录角色产生的荒谬脑补或误会），让后续的聊天模型能清晰感知到此处的“暧昧张力”。
...
▌sub 支线节点——同时满足以下全部条件才为 sub：
   ...
   ?? 不足以单独成立的次要细节不是 sub，写入所属 main/pivot 节点的 sub_notes
...
× 压缩正文写至一半便输出 ni_meta
× 将正文压缩至"梗概"程度
× 以“客观压缩”为由，将充满张力或暧昧的互动细节（如羞涩、误会、调情）阉割成干瘪的流水账。必须保留供用户介入的“情绪钩子”。
  ...
  "plots": [
    {
      ...
      "type": "main|sub|pivot",
      "title": "剧情标题",
      "body": "剧情详细描述。禁止一笔带过！必须包含：① 场景与氛围；② 人物关键动作交锋；③ 极具张力的台词（必须带双引号），尤其是角色自报家门、确认身份、亲密称呼的原话；④ 面对新名字或新互动时的心理与神态反应。字数保持在 150～350 字左右。",
...
- 若本段揭示了前段已登场但当时未知姓名的角色，必须在 character_aliases 中将前文旧称与新名字明确绑定，或在 identity 中注明
